...
//		UserDefineLibrary.insertWord("网大学", "ab", 1000);
		...
		UserDefineLibrary.insertWord("泰国", "brand", 1000);
		UserDefineLibrary.insertWord("新西兰", "brand", 1000);
		
		System.out.println(DicAnalysis.parse("泰国"));
		System.out.println(DicAnalysis.parse("新西兰"));
		System.out.println(DicAnalysis.parse("重庆泰国重庆市新西兰渝北区金童路奥山别墅abc162"));
